...
// Add event listeners to each puzzle piece for the 'pointerdown' event - when a puzzle piece is picked up
...
function grabPiece(e) {
  // Highlight the piece by increasing its brightness - helping the user see which piece is selected
...
function dropPiece(e) {
  ...
  // Remove the highlight from the piece to indicate that the user is no longer holding it
